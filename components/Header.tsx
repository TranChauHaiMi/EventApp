            ...
            <div className="hidden lg:block ml-auto">
                <SignedIn>
                    <div className="flex items-center gap-3">
                        <Link href="/seller">
                            <button className="bg-blue-600 text-white px-3 py-1.5 text-base rounded-lg hover:bg-blue-700 transition font-semibold">
                                Bán vé
                            </button>
                        </Link>
            ...
            <div className="lg:hidden w-full flex justify-center gap-3">
                <SignedIn>
                    <Link href="/seller" className="flex-1">
                        <button className="w-full bg-blue-600 text-white px-3 py-1.5 text-base rounded-lg hover:bg-blue-700 transition font-semibold">
                            Bán vé
                        </button>
                    </Link>
