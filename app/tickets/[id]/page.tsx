        ...
        <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
                ...
                >
                    ...
                    >
                        {ticket.event.is_cancelled
                        ? "Nếu bạn có thắc mắc về việc hoàn tiền hoặc hủy sự kiện, vui lòng liên hệ đội ngũ hỗ trợ của chúng tôi qua địa chỉ team@papareact-tickr.com"
                        : "Nếu bạn gặp sự cố với vé của mình, vui lòng liên hệ đội ngũ hỗ trợ của chúng tôi qua địa chỉ team@papareact-tickr.com"}
                    </p>
                </div>
            </div>
        </div>
